...
<Dropdown class="ms-sm-3 header-item topbar-user">
    ...
    <DropdownMenu class="dropdown-menu-end" end>
        ...
        <DropdownItem href={null}><i class="mdi mdi-message-text-outline text-muted fs-16 align-middle me-1" />
        ...
        <DropdownItem href={null}><i class="mdi mdi-lifebuoy text-muted fs-16 align-middle me-1" />
            <span class="align-middle">Help</span>
        </DropdownItem>
        <div class="dropdown-divider" />
        <DropdownItem href={null}><i class="mdi mdi-wallet text-muted fs-16 align-middle me-1" />
            <span class="align-middle">Balance : <b>$5971.67</b></span>
        </DropdownItem>
        <DropdownItem href={null}><span

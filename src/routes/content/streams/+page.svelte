<script>
  ...
  function setCategory(category) {
    ...
    if (displayCategory === "All") {
      ...
      gallery = originalGallery.filter(
                  ...
                  >
                    ...
                    <li class="list-inline-item">
                      <a
                        ...
                        class={displayCategory === "Designing"
                          ? "categories active"
                          : "categories"}
                  ...
                  <div class="col element-item project designing development">
                    <Card class="gallery-box">
                      <div class="gallery-container">
                        <Link class="image-popup" href={null} title="">
                          <img
                      ...
                      <div class="box-content">
                        <div class="d-flex align-items-center mt-1">
                          <div class="flex-grow-1 text-muted">
                            by <Link href={null} class="text-body text-truncate"
                              >{item.auther}</Link
                            >
                          </div>

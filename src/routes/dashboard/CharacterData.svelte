<script>
  ...
  import CharacterDataCharts from "./CharacterDataCharts.svelte";
</script>
    ...
    <CardBody>
      ...
      <div class="mt-3">
        <div class="d-flex justify-content-center align-items-center mb-4">
          ...
          <div>
            ...
            <p class="text-success fw-medium mb-0">
              <span
                class="badge bg-success-subtle text-success p-1 rounded-circle"
        ...
        <div class="d-flex justify-content-between py-2">
          <p class="fw-medium mb-0">
            <i
              class="ri-checkbox-blank-circle-fill text-secondary align-middle me-2"
            />
            Cancelled
          </p>
          <div>

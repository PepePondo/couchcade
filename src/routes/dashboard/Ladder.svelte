<script>
  ...
  import LadderDataCharts from "./LadderDataCharts.svelte";

  export let ladderDataCharts;
</script>
          ...
          <tbody>
            {#each ladderDataCharts as item}
              <tr>
                ...
                <td>
                  <h6 class="mb-0">
                    {item.hours}h : <span class="text-muted"> 150h </span>
                  </h6>
                </td>
                <td>
                  {item.tasks}

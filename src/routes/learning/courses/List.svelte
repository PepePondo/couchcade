            ...
            <div class="d-flex flex-column h-100">
              ...
              <div class="d-flex mb-2">
                <div class="flex-shrink-0 me-3">
                  <div class="avatar-sm">
                    <span
                      class={"avatar-title rounded p-2 bg-" +
                        item.imgbgColor +
                        "-subtle"}
                    >
                ...
                <div class="flex-grow-1">
                  <h5 class="mb-1 fs-15">
                    <Link
                      ...
                      class="text-dark">{item.label}</Link
                    >
                  </h5>
    ...
    {:else if item.isDesign2}
      <Col xxl={3} sm={6} class="project-card">
        <Card>
          <CardBody>
            <div
              class={`p-3 mt-n3 mx-n3 bg-${item.cardHeaderClass}-subtle rounded-top`}
            >
              <div class="d-flex align-items-center">
                <div class="flex-grow-1">
                  <h5 class="mb-0 fs-14">
    ...
    {:else if item.isDesign3}
      <Col xxl={3} sm={6} class="project-card">
        <Card>
          <CardBody>
            <div
              class={`p-3 mt-n3 mx-n3 bg-${item.cardHeaderClass} rounded-top`}
            >
              <div

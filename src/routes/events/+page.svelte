<script>
  ...
  import CalendarEventsList from "../../common/data/calendar";
            ...
            <Card class="card-h-100">
              <CardBody>
                ...
                <div id="external-events">
                  ...
                  >
                    <i class="mdi mdi-checkbox-blank-circle me-2" />New Event
                    Planning
                  </div>
                  <div
                  ...
                  >
                    <i class="mdi mdi-checkbox-blank-circle me-2" />Meeting
                  </div>
                  <div
                    class="external-event fc-event bg-warning-subtle text-warning"
                    data-class="bg-warning-subtle"
                  >
                    <i class="mdi mdi-checkbox-blank-circle me-2" />Generating
                    Reports
                  </div>
                  <div
                  ...
                  >
                    <i class="mdi mdi-checkbox-blank-circle me-2" />Create New
                    theme
                  </div>
                </div>
              </CardBody>
      ...
      <Row class="mt-2">
        <Col xs="12" class="text-end">
          {#if !!isedit}
            ...
            >
          {/if}
          <button type="button" class="btn btn-light me-2" on:click={toggle}>
            Close
          </button>

<script>
  ...
  import data from "../../common/data/ecommerce.js";
              ...
              <div class="d-flex">
                <div class="flex-grow-1">
                  ...
                  <div class="hstack gap-3 flex-wrap">
                    <div>
                      <a href={null} class="text-primary d-block"
                        >Tommy Hilfiger</a
                      >
                    </div>
                    <div class="vr" />
                    ...
                    <div class="vr" />
                    <div class="text-muted">
                      Published : <span class="text-body fw-medium"
                        >26 Mar, 2021</span
                      >
                    </div>
                  </div>
                ...
                <Col xl={6}>
                  <div class=" mt-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                      <Tooltip target="color-1" placement="top"
                      ...
                      <Tooltip target="color-2" placement="top"
                        >03 Items Available</Tooltip
                      >
                      ...
                      <Tooltip target="color-3" placement="top"
                        >03 Items Available</Tooltip
                      >
                      ...
                      <Tooltip target="color-4" placement="top"
                        >02 Items Available</Tooltip
                      >
                      <Button
                        id="color-4"
                        type="button"

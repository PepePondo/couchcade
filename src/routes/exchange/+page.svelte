<script>
  ...
  import data from "../../common/data/NFTMarketplace.js";
        ...
        <Card class="bg-primary" style="background-image: url({BgPattern})">
          <CardBody class="p-4">
            ...
            <p class="text-white text-opacity-75 mb-3">
              Take advantage of the first text-based NFT. Select a text or write
              your own and let it live forever on the Ethereum blockchain you or
              future owners can add text to an existing ChainText token..
            </p>
    ...
    <Row>
      <Col lg={12}>
        <Card class="overflow-hidden shadow-none">
          <CardBody class="bg-success-subtle text-success fw-semibold d-flex">
            <Marquee speed={50}>
              ...
              rare. NFTs get their value because the transaction proves
